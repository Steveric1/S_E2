...
const builtins_t *get_builtins(const char *name)
{
    ...
    static builtins_t setenv_builtin = {"setenv", __setenv, SETENV_HELP, SETENV_DESC};
    static builtins_t unsetenv_builtin = {"unsetenv", __unsetenv, UNSETENV_HELP, UNSETENV_DESC};
...
int main()
{
	...
	if (built != NULL) {
        ...
        printf("Built-in command '%s' not found.\n", command);
    }
}